...
internal class EditProductViewModel : ViewModel
{
    ...
    public EditProductViewModel(Product edit, MainViewModel mainViewModel, ISetValuesProduct setValuesProduct, ISaveEditProduct saveEditProduct)
    {
        original = edit;
        ...
        Save = new Command(() =>
        {
            try
            {
                ...
                setValuesProduct.SetValuesProduct(original, EditProduct);
